...
CANONICAL_ALIASES = {
    "employee_id": ["employee_id", "employeeid", "id", "matricule", "emp_id", "personnel_id", "employee_number", "empid"],
    ...
    "salary": ["salary", "salaire", "monthly_salary", "monthly_income", "compensation", "wage", "monthlyincome"],
    "hire_date": ["hire_date", "date_embauche", "start_date", "employment_date", "datehire"],
    "tenure_years": ["tenure_years", "anciennete", "seniority", "tenure", "years_at_company", "total_working_years", "yearsatcompany"],
    "training_hours": ["training_hours", "formation", "formation_heures", "hours_training", "training", "training_times_last_year", "trainingtimeslastyear"],
    "performance_score": ["performance_score", "performance", "evaluation", "rating", "score_performance", "performance_rating", "performancerating"],
    "satisfaction_score": [
        "satisfaction_score",
        "satisfaction",
        "engagement",
